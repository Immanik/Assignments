#  Create a numpy array with 10 elements of the shape(10,1) using np.random and find out the mean of the
...
#Create a numpy array with 20 elements of the shape(20,1) using np.random find the variance and standard
...
#Create a numpy array A of shape(10,20) and B of shape (20,25) using np.random. Print the matrix which is the
