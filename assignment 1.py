...
s1 =  "Manik" #I take first string.
s2 = "Tyagi" #another string.
print(s1+s2) #here, we are using '+' to join two sttings i.e. s1 & s2.

# Take the input of three variables x,y and z and print their values.
...
#Print "Lets get's started" on screen.

print("Lets get's started") #here we simply prints above statement.

#Print the following values using place holders s="Acadview" course="Python" fees=5000
...
#let's do intresting exercise: name="Tony shark" salary=1000000 print(%s %d)%(____,____)
name="Tony Shark"
salary=1000000
