# Take an input year from the user and dicide whether it is a leap year or not.
...
# take length and breadth input from user and check whether the dimensions are of sqaure or rectangle.
...
if (first_side==third_side and second_side==fourth_side): #checks the condition of being rectangle.
 ...
 # Take the input age of 3 people  and determine thw oldest and the youngest one among them.
